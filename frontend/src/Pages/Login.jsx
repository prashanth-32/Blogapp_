    ...
    <>
        <div className='bg-black text-white w-screen h-screen flex flex-col justify-center gap-10'>
            ...
            <form action="" className= 'flex flex-col gap-10 items-center justify-center'>
                ...
                <button className='bg-white text-black p-2 rounded-md font-bold' onClick = {(e) => handleClick(e)}>Login</button>
                <p>Create a new account?<Link to={'/register'} className='text-gray-500'> Click here</Link> </p>
            </form>
        </div>
    </>
  )
