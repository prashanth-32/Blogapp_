  ...
  return (
    <div>
            ...
            <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
              <input onChange={(e)=>setTitle(e.target.value)} value={title} type="text" placeholder='Enter post title' className='px-4 py-2 outline-none border-black border rounded-md'/>
              ...
              <textarea onChange={(e)=>setDesc(e.target.value)} rows={15} cols={30} value={desc} className='px-4 py-2 outline-none border-black border rounded-md' placeholder='Enter post description'/>
